 ...
 * DEMO-VERSION MIT NUR 5 FRAGEN PRO DURCHGANG
 * 
    ...
    public static void main(String[] args) {
        ...
        if (jn=='j') {
            do {
                ...
                fragen.getFragenliste()[i] = new Frage(frage, antworten, a);
        ...
        //Anzahl der Fragen begrenzen: (Demo = 5 Fragen)
        z = 4;
        ...
        if (eingabe == 0) {
            ...
            System.out.println("\nDurchlauf beendet, 5/5 Fragen der Demoversion wurden beantwortet.");
        }
